...
- [Conjugação Padrão](#conjugação-padrão)
  - [Verbos com prefixo de objeto](#verbos-com-prefixo-de-objeto)
  - [Verbos com prefixo de sujeito](#verbos-com-prefixo-de-sujeito)

1. [Negação: _õ di_](#negação-õ-di)
   - [Negativo passado](#negativo-passado)
   - [Negativo futuro](#negativo-futuro)
1. [Sem: _ãna_](#sem-ãna)
1. [Em busca resposta sim ou não: _dzô_](#em-busca-resposta-sim-ou-não-dzô)
1. [Objetivo, ser: _da_](#objetivo-ser-da)
   - [Objetivo negativo, não ser: _tõ da_](#objetivo-negativo-não-ser-tõ-da)
1. [Objetivo único: _da tsi_](#objetivo-único-da-tsi)
1. [Se, quando, casualidade: _wamhã_](#se-quando-casualidade-wamhã)
1. [Somente quando: _waptsi_](#somente-quando-waptsi)
1. [Depois: _parimhã_](#depois-parimhã)
1. [Somente depois: _pariptsi_](#somente-depois-pariptsi)
1. [Antes: _wana ré_](#antes-wana-ré)
1. [Apesar, mesmo: _nherẽ_](#apesar-mesmo-nherẽ)
   - [Apesar de não, a menos que, senão: _õ nherẽ_](#apesar-de-não-a-menos-que-senão-õ-nherẽ)
1. [Motivo: _wa_](#motivo-wa)
1. [Motivo sentimental: _te_](#motivo-sentimental-te)
1. [Por causa: _uꞌöbö_](#por-causa-uꞌöbö)
1. [Através, por meio: _hawi_](#através-por-meio-hawi)
1. [Dever, obrigação: _ĩ[verbo] da tsi_](#dever-obrigação-ĩverbo-da-tsi)
1. [De acordo com, conforme: _dzarina_](#de-acordo-com-conforme-dzarina)
1. [Coisa, lugar, ocasião, maneira: _ĩ[verbo] dzé_](#coisa-lugar-ocasião-maneira-ĩverbodzé)
   - [Indica onde a ação é realizada](#indica-onde-em-que-no-qual-a-ação-é-realizada-pronome-interrogativoconjunção)
   - [Indica quando a ação é realizada](#indica-quando-a-ação-é-realizada)
   - [Indica aquilo que, o que é realizado](#indica-aquilo-que-o-que-é-realizado)
   - [Indica a maneira como a ação é feia, o jeito que é feita](#indica-a-maneira-como-a-ação-é-feia-o-jeito-que-é-feita)
   - [Indica o verbo impessoal, oração sem sujeito, voz passiva sintética](#indica-o-verbo-impessoal-oração-sem-sujeito-voz-passiva-sintética)
1. [Enquanto (sujeitos diferentes): _ré_](#enquanto-sujeitos-diferentes-ré)
1. [Enquanto (sujeitos iguais): _tsina_](#enquanto-sujeitos-iguais-tsina)
1. [Comparação: _ĩ[verbo] ne_](#comparação-ĩverbo-ne)
1. [Suposição, irrealidade: _newa_](#suposição-irrealidade-newa)
1. [Futuro do pretérito (se tivesse...): _waꞌöhã_](#futuro-do-pretérito-se-tivesse-waꞌöhã)
1. [Capacidade, conseguir fazer: _waihuꞌu petse di_](#capacidade-conseguir-fazer-waihuꞌu-petse-di)
   - [Negativo, não ter capaciade: _waihuꞌu õ di_](#negativo-não-ter-capaciade-waihuꞌu-õ-di)
1. [Grupo de sujeitos: _ĩ[verbo] norĩ_](#grupo-de-sujeitos-ĩverbo-norĩ)
1. [Conjunção: _ĩ[verbo] na_](#conjunção-ĩverbo-na)
1. [Pronome relativo: _ĩ[verbo]_](#pronome-relativo-ĩverbo)
   - [Qual está certo? _te te ĩnharĩ hã_ ou _te tinha_?](#qual-está-certo-te-te-ĩnharĩ-hã-ou-te-tinha)
1. [Agradável, prazeroso: _dze ti_](#agradável-prazeroso-dze-ti)
1. [Desagradável, indesejável: _a di_](#desagradável-indesejável-a-di)
1. [Significado oposto ou irônico: _bö_](#significado-oposto-ou-irônico-bö)
1. [Possibilidade: _õꞌumnhatsite_](#possibilidade-õꞌumnhatsite)
1. [Um depois do outro, em cada, a medida que: _tsidöpötsi_](#um-depois-do-outro-em-cada-a-medida-que-tsidöpötsi)
1. [Em troca, ao invés: _waꞌrãmi_](#em-troca-ao-invés-waꞌrãmi)
1. [No lugar de: _upana_](#no-lugar-de-upana)
1. [Mais que, além de: _nhipai u_](#mais-que-além-de-nhipai-u)
1. nedza Ref. 1 Tes 2:18
1. döꞌötsina
1. ꞌrudza
1. ate
1. wab da
...
## Em busca, resposta sim ou não: _dzô_
...
- `wa tsadanha te te waihuꞌu dzô` eu o perguntei se ele entendeu ou não
- `Awẽ tsidöpö, ma tô Ĩbaihö Ĩwadzé petse na robꞌuiꞌéré hã natsi tsõré dzaꞌra, Paulo nhimirowatsuꞌu hã tô tsena dzô.` Todos dias, eles sempre liam as Sagradas Escrituras, com o objetivo de saber se a explicação de Paulo era verdade ou não.
...
### Objetivo negativo, não ser: _tõ da_
...
## Objetivo único: _da tsi_

- `wa ꞌre ĩ̱höimana te romhuri da tsi` Eu vivo só para trabalhar
- `...Tadzahã wawasété da si õ di.` ...Mas não só pelos nossos pecados.

---

## Se, quando, casualidade: _wamhã_
...
### Apesar de não, a menos que, senão: _õ nherẽ_
...
## Dever, obrigação: _ĩ\[verbo\] da tsi_

- `te te ĩromhuri dzaꞌra da tsi` eles devem trabalhar

---

## De acordo com, conforme: _dzarina_
...
## Coisa, lugar, ocasião, maneira: _ĩ\[verbo\]dzé_
...
## Enquanto (sujeitos diferentes): _ré_
...
## Enquanto (sujeitos iguais): _tsina_
...
## Futuro do pretérito (se tivesse...): _waꞌöhã_
...
## Capacidade, conseguir fazer: _waihuꞌu petse di_
...
## Grupo de sujeitos: _ĩ\[verbo\] norĩ_
...
## Conjunção: _ĩ\[verbo\] na_

A conjunção _ĩ\[verbo\] na_ é usada para ligar dois verbos de duas orações. Ela tem o efeito de transformar a oração em um todo, gerando um sentido de sequência ou de consequência. Além disso, ela ajuda a marcar a ordem temporal das ações.

Por exemplo, na frase "Sei que em breve vocês me verão novamente" temos dois verbos: "sei" e "verei". A conjunção _na_ liga esses dois verbos, tornando a oração mais organizada e clara. Isso ajuda o ouvinte a entender melhor a ordem temporal das ações.

- `ĩ̱ma waihuꞌu petse di romhutu na dza ĩ̱ꞌmadöꞌö na apö` (1) eu sei (2) que em breve vocês me verão novamente
- `ĩ̱ma waihuꞌu petse di niwa dza oto ĩ̱ꞌmadöꞌö õ na` (1) eu sei (2) que nunca mais vocês me verão
- `wa tô tsadaihuꞌu dza te te ĩꞌaipawaptom na` (1) eu entendi (2) que ele vai te ajudar
- `Ma tô tinha datoi u we ĩmorĩ na aré` (1) ele afirmou (2) que viria à festa
- `Wa tô tsadaihuꞌu dzaꞌra ni romhöimanadzé ĩpire na` (1) nós entendemos (2) que a situação era difícil
- `Dama romnhoréꞌwa ma tô ãma rowatsuꞌu romhuri dza ĩwapu na` (1) a professora explicou (2) que o trabalho seria fácil

Note que a conjunção _na_ pode ser usada para ligar orações que tenham verbos em diferentes tempos verbais, como "sei" (presente) e "verei" (futuro). Isso ajuda a marcar a ordem temporal das ações e a tornar a oração mais clara e organizada.

---

## Pronome relativo: _ĩ\[verbo\]_
...
1. E João que disse assim.
1. E João disse assim.
1. E o que João disse é assim:
...
## Desagradável, indesejável: _a di_
...
## Significado oposto ou irônico: _bö_
...
## Um depois do outro, em cada, a medida que: _tsidöpötsi_
