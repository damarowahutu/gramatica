...
Esta tabela de conjugação se parece com a encontrada no artigo sobre os [objetos diretos]({{ site.baseurl }}/conteudo/objeto/direto/). Porém a tabela é simplificada, pois não precisamos nos preocupar com o "lado direito" da conjugação, ou seja, não precisamos usar `dzahuré`, `dzaꞌra` nem `waꞌaba`.
